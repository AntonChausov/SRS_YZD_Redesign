...
5. Создайте команду "ОК" разместите ее в командной панели списка, установите для кнопки свойство КнопкаПоУмолчанию в значение Истина
6. Для списка элементов (основного списка формы) задайте событие Выбор. В нем - 
